...
import com.example.weatherapp.Activity.WeatherForecast;
...
public class DailyWeatherAdapter extends ArrayAdapter<WeatherForecast> {

    private Context context;
    private List<WeatherForecast>  weatherList;

    public DailyWeatherAdapter(@NonNull Context context, @NonNull List<WeatherForecast> weatherList) {
